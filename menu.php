...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1P8G8PG8GT"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-1P8G8PG8GT');
</script>
</head>
...
<body class="home page-template-default page page-id-2 woocommerce-no-js">
    ...
    <!-- Begin mobile menu
    <div class="hasbg mobile_menu_wrapper">
        <a id="close_mobile_menu" href="javascript:;"><i class="fa fa-close"></i></a>
        <div class="menu-side-menu-container">
            <ul id="mobile_main_menu" class="mobile_main_nav">
                <li class="menu-item"><a href="index.html">Home</a>
                                        </li>
                                        <li class="menu-item current-menu-item"><a href="menucompleto.html">Cardápio</a>
                                        </li>
                                        <li class="menu-item"><a href="sobrenos.html">Sobre nós</a>
                                        <li class="menu-item"><a href="contato.html">Contato</a>
                                        </li>
                                        <!--<li class="menu-item"><a href="promocoes.html">Promoções</a>
                                        </li>
            </ul>
        </div>
        <!-- Begin Reservation 
        <a href="https://wa.me/551434361909?text=Olá Austin! Tenho interesse em fazer uma reserva!" id="tg_sidemenu_reservation" class="button" target="_blank">Reservas <i class="fa fa-whatsapp"></i></a>
        <!-- End Reservation 
                ...
                <div id="menu_wrapper">
                    ...
                    <div id="logo_normal" class="logo_container">
                        <div class="logo_align">
                            ...
                            <img src="images/austinpreto.png" alt="Grand Restaurant | Restaurant Theme" width="101" height="34" style="width:101px;height:34px;"/>
                            </a>
                        </div>
                    </div>
                    <div id="logo_transparent" class="logo_container">
                        <div class="logo_align">
                            ...
                            <img src="images/logo.png" alt="Grand Restaurant | Restaurant Theme" />
                            </a>
                        </div>
                    </div>
                    <!-- End logo -->
                    ...
                    <div class="menu_buttons_container">
                        <div class="menu_buttons_content">
                            <!-- Begin Reservation -->
                            <a href="https://wa.me/551434361909?text=Olá Austin! Tenho interesse em fazer uma reserva!" id="tg_reservation" class="button" target="_blank">reservas  <i class="fa fa-whatsapp"></i></a>
                            <!-- End Reservation -->
                            <!-- Begin side menu 
                            ...
                            <div id="menu_border_wrapper">
                                <div class="menu-main-menu-container">
                                    <ul id="main_menu" class="nav">
                                        ...
                                        <li class="menu-item "><a href="confraria.html">Confraria</a>
                                        </li>
                                        <li class="menu-item"><a href="sobrenos.html">Sobre nós</a>
                                        <li class="menu-item"><a href="contato.html">Contato</a>
                                        </li>
    ...
    <div id="page_caption" class="hasbg parallax baseline ">
        ...
        <div id="bg_regular" style="background-image:url(images/fotos-que-faltavam/menus/steaks-menu.jpg);"></div>
        ...
        <div class="page_title_wrapper baseline" data-stellar-ratio="1.3">
            <div class="page_title_inner baseline">
                <h1 class="withtopbar">
                 <span class="ppb_title_first" >Nosso</span>Cardápio  </h1>
            </div>
        </div>
    </div><br>
                ...
                <div class="portfolio_filter_wrapper four_cols gallery portfolio-content section content clearfix">
                        ...
                        <div class="one_fourth gallery4 filterable static animated1">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="entrada.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/rustic-fries3.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3194" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3194" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Entradas</span>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated2">
                            <div class="button_wrapper">
                                <div class="button_center">
                                   <div class="button_content"><a href="saladas.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/Caesar-salad-chicken.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3195" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3195" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Saladas</span>
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated3">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="kids.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/filezinho-frango-kids.jpg" alt="" /></div>
                        <br class="clear" />
                    ...
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated4">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="burger.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/burgers/austin-power.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3197" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3197" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Burger</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated5">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="steaks.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/picanha3.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3190" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3190" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Steaks</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated6">
                            <div class="button_wrapper">
                                <div class="button_center">
                                   <div class="button_content"><a href="steaksfamilia.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/steaks/t-bone.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3191" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3191" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Steaks Família</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated7">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="massas.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/massas/talharim-pesto.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3192" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3192" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Massas</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                     <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated7">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="risotos.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/risotos.png" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3192" class="portfolio_desc portfolio4 filterable ">
                            <div id="menu_3192" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Risotos</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated8">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="sobremesas.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/Petit-gateau4.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3193" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3193" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Sobremesas e Cafés Nespresso</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated8">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="drinks.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/cosmo.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3193" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3193" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Drinks</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated8">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="bebidas.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/suco-laranja.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3193" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3193" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Bebidas</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated8">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="vinho.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/vinho2.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3193" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3193" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Vinhos</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="element classic3_cols">
                        <div class="one_fourth gallery4 filterable static animated8">
                            <div class="button_wrapper">
                                <div class="button_center">
                                    <div class="button_content"><a href="happyhour.html"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div><img src="images/chopp-400.jpg" alt="" /></div>
                        <br class="clear" />
                        <div id="portfolio_desc_3193" class="portfolio_desc portfolio4 filterable last">
                            <div id="menu_3193" class="menu_content_classic">
                                <h5 class="menu_post">
                                    <span class="menu_title">Happy Hour</span>
                                    <span class="menu_dots"></span></h5>
                            </div>
                        </div>
                    </div>
...
<br><br>
        <center><h5> ** Valores sujeitos a alterações sem aviso prévio.</h5></center>
        <br><br>
    <div class="footer_bar ">
            ...
            <ul class="sidebar_widget four">
                ...
                <div class="textwidget">
                    ...
                    <div class="social_wrapper shortcode dark ">
                        <ul>
                            <li class="facebook"><a target="_blank" title="Facebook" href="https://www.facebook.com/austinsteak/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                            <li class="instagram"><a target="_blank" title="Instagram" href="https://www.instagram.com/austinsteak/?hl=pt-br" target="_blank"><i class="fa fa-instagram"></i></a></li>
                            <li class="instagram"><a target="_blank" title="Whatasapp" href="tel:+551434361909" target="_blank"><i class="fa fa-whatsapp"></i></a></li>
                        </ul> 
                   </div>
                </div>
                </li>
        ...
        <div class="footer_bar_wrapper ">
               <center> Copyright © 2020 | Todos os Direitos Reservados | Desenvolvido por <a href="http://atitudecomunicacao.com.br/" style="color: #EEAB05"><img style="width: 35px; height: 35px; margin-left: 5px;" src="images/atitude_negativo.png"></a></center>
            <br class="clear"/>
